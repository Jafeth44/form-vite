...
function logPluginError(error2, plugin, { hook, id } = {}) {
  if (error2.code && !error2.code.startsWith("PLUGIN_") && !error2.pluginCode) {
...
var ModuleLoader = class {
  ...
  async loadEntryModule(unresolvedId, isEntry, importer, implicitlyLoadedBefore) {
    ...
    if (resolveIdResult === false || typeof resolveIdResult === "object" && resolveIdResult.external) {
      return error(implicitlyLoadedBefore === null ? logEntryCannotBeExternal(unresolvedId) : logImplicitDependantCannotBeExternal(unresolvedId, implicitlyLoadedBefore));
    }
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-RGSBQLFV.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-DAU76JUA.js.map
